...
choices_month=[('1','Jan'),('2','Feb'),('3','Mar'),('4','Apr'),('5','May'),('6','Jun'),('7','Jul'),('8','Aug'),('9','Sept'),('10','Oct'),('11','Nov'),('12','Dec')]
...
class SampleForm(forms.Form):
    first_name= forms.CharField(max_length=20,required=True,label="Fisrt Name",help_text='Spaces and Special characters are not allowed')
    ...
    phone= forms.IntegerField(max_value=9999999999,min_value=6000000000, required=True,help_text="No country codes")
    #phone= forms.RegexField(max_length=10,min_length=10,required=True,regex=r'[6-9]\d{9}')
    pwd= forms.CharField(max_length=20, required=True,widget=forms.PasswordInput)
    #To get the dropdown we use ChoiceField
    ...
    #To get Radio button we need to go for ChoiceField only but we need to add widget as forms.RadioSelect
